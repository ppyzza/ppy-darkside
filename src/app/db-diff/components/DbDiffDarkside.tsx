...
export default function DbDiffDarkside(props: DbDiffProps) {
  const {
  ...
  return (
          <div key={tableName} style={{ marginBottom: '8px', border: '1px solid var(--app-border)', borderRadius: '8px', background: '#FFEBEB' }}>
      ...
      if (!tgtCols) {
        ...
        return (
          <div key={tableName} style={{ marginBottom: '8px', border: '1px solid var(--app-border)', borderRadius: '8px', background: 'rgba(16, 185, 129, 0.1)' }}>
      ...
      const renderDataDiff = () => {
        ...
        return (
          <div style={{ marginTop: '8px', fontSize: '11px', borderTop: '1px solid var(--app-border)', paddingTop: '4px' }}>
            ...
            <div style={{ marginTop: '4px', maxHeight: '100px', overflowY: 'auto', background: '#F9F9F9', padding: '4px', border: '1px solid var(--app-border)', borderRadius: '8px' }}>
  ...
  return (
    <div className="app-window" style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--app-border)' }} style={{ height: '100%', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '16px', background: 'var(--app-bg)', borderBottom: '1px solid var(--app-border)' }}>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end' }}>
              <button className="btn btn-primary" style={{ borderRadius: '6px', padding: '8px 16px', background: 'var(--app-blue)' }} onClick={handleCompare} disabled={comparing}>
