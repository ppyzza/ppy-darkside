...
export default function SeedWizardGlass(props: SeedWizardProps) {
  const {
  ...
  return (
    <div className="app-window" style={{ background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', borderRadius: '24px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }} style={{ height: '100%', maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="app-content" style={{ display: 'flex', flexDirection: 'column', flex: 1, padding: 0 }}>
        ...
        {/* Mode Toggle */}
        <div style={{ padding: '8px', borderBottom: '1px solid var(--app-border)', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', display: 'flex', gap: '16px', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', flex: 1 }}>
          ...
          {/* Right Content Area */}
          <div style={{ flex: 1, padding: '24px', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
            ...
            {step === 1 && (
              <div>
                ...
                {wizardMode === 'entity' && (
                  <div style={{ marginBottom: '24px', padding: '12px', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      />
                      <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={scanEntities} disabled={scanningEntities}>
                    ...
                    {scanSummary && (
                      <div style={{ marginTop: '16px', background: 'rgba(255, 255, 255, 0.1)', padding: '16px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <h4 style={{ margin: 0, fontSize: '12px' }}>Scan Summary (Join Depths)</h4>
                          <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} style={{ fontSize: '10px' }} onClick={() => {
                          ...
                          {Object.keys(scanSummary).map(Number).sort((a, b) => a - b).map(depth => {
                            ...
                            return (
                              <div key={depth}>
                                ...
                                <div style={{ fontSize: '10px', maxHeight: '150px', overflow: 'auto', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', padding: '4px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}>
                ...
                <div className="flex justify-end border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)' }}>
                  <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={handleConnect} disabled={connecting || (wizardMode === 'entity' && entities.length === 0)}>
                    Next {'>'}
                  </button>
                </div>
              </div>
            ...
            {step === 2 && (
              <div>
                ...
                {wizardMode === 'entity' ? (
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <div className="flex justify-end border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)', marginTop: '24px' }}>
                      <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setStep(1)}>{'< Back'}</button>
                      <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={() => {
                ...
                <div style={{ marginBottom: '16px' }}>
                  ...
                  {(!manualTable && tables.length > 0) ? (
                    ...
                    <div>
                      ...
                      />
                      <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} style={{ width: '80px', marginLeft: '8px' }} onClick={() => fetchColumnsForTable(selectedTable)} disabled={!selectedTable || fetchingCols}>
                        Load
                      </button>
                    </div>
                  )}
                ...
                <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
                  {/* Left Box: Templates */}
                  <div style={{ flex: 1, background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', padding: '16px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div style={{ background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', padding: '16px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}>
                    ...
                    <div style={{ background: 'rgba(16, 185, 129, 0.1)', padding: '16px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                      <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center' }}>⏬ Load Existing DB Data:</label>
                      <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={loadExistingData} disabled={loadingData || !selectedTable || columns.length === 0} style={{ padding: '4px 16px', fontWeight: 'bold' }}>
                ...
                {csvHeaders.length > 0 && (
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ padding: '8px', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', color: 'green', fontSize: '11px', fontWeight: 'bold', marginBottom: '8px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                      <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                        ...
                        <button 
                          className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} 
                          onClick={() => {
                            const newRow: any = {};
                    ...
                    <div style={{ maxHeight: '300px', overflow: 'auto', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)' }}>
                      <table style={{ width: 'max-content', borderCollapse: 'collapse', fontSize: '11px' }}>
                        <thead style={{ background: 'rgba(255, 255, 255, 0.1)', position: 'sticky', top: 0, zIndex: 1 }}>
                          <tr>
                            <th style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '4px', background: 'rgba(255, 255, 255, 0.1)' }}>#</th>
                            <th style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '4px', background: 'rgba(255, 255, 255, 0.1)' }}>Actions</th>
                            {csvHeaders.map(h => (
                              <th key={h} style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '4px', background: 'rgba(255, 255, 255, 0.1)' }}>{h}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                          {csvData.slice(editorPage * 100, (editorPage + 1) * 100).map((row: any, mapIdx: number) => {
                            ...
                            return (
                              <tr key={rIdx}>
                                <td style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '4px', background: 'rgba(255, 255, 255, 0.1)', textAlign: 'center', color: '#666' }}>{rIdx + 1}</td>
                                <td style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '4px', background: 'rgba(255, 255, 255, 0.1)', textAlign: 'center' }}>
                                  <button 
                                    className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} 
                                ...
                                {csvHeaders.map(h => {
                                  ...
                                  return (
                                    <td key={h} style={{ border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: 0 }}>
                                      {isEnum ? (
                                        <select 
                                          value={row[h] || ''} 
                                          onChange={(e) => {
                ...
                <div className="flex justify-between border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)' }}>
                  <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setStep(1)}>{'< Back'}</button>
                  <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={goToMapping} disabled={!selectedTable || csvHeaders.length === 0}>
                    Next {'>'}
                  </button>
                </div>
                ...
                {editingRowIdx !== null && editFormData && (
                  <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
                    <div className="app-window" style={{ background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', borderRadius: '24px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)' }} style={{ width: '400px', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
                      <div className="app-titlebar" style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', fontSize: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                      ...
                      <div className="app-content" style={{ overflow: 'auto', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', flex: 1, padding: '16px' }}>
                              ...
                              <div key={h}>
                                ...
                                {isEnum ? (
                                  ...
                                  <input 
                                    ...
                                    value={editFormData[h] || ''} 
                                    onChange={(e) => setEditFormData({...editFormData, [h]: e.target.value})}
                                    style={{ width: '100%', padding: '4px', fontSize: '11px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px' }}
                                  />
                                )}
                              </div>
                            );
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '16px', paddingTop: '16px', borderTop: '1px solid var(--app-border)' }}>
                          <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setEditingRowIdx(null)}>Cancel</button>
                          <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={() => {
                            const newData = [...csvData];
...
{step === 3 && (
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                {wizardMode === 'entity' ? (
                  <div style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', gap: '16px', flex: 1, overflow: 'hidden' }}>
                      ...
                      <div style={{ width: '250px', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column' }}>
                        <div style={{ padding: '8px', borderBottom: '1px solid var(--app-border)', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      {/* Right: Active Form */}
                      <div style={{ flex: 1, background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                        <div style={{ padding: '8px', borderBottom: '1px solid var(--app-border)', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <strong>{activeRecordIndex !== null ? `Editing Record #${activeRecordIndex + 1}` : 'New Record'}</strong>
                          <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} style={{ fontSize: '10px' }} onClick={() => {
                    ...
                    <div className="flex justify-between border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)', marginTop: '16px' }}>
                      <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setStep(2)}>{'< Back'}</button>
                      <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={performEntityExport} disabled={entityFormDataList.length === 0}>
                        Generate SQL {'>'}
                      </button>
                    </div>
                  </div>
                ...
                <div style={{ flex: 1, overflow: 'auto', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', marginBottom: '16px' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '11px' }}>
                    <thead style={{ background: 'rgba(255, 255, 255, 0.1)', borderBottom: '1px solid var(--app-border)' }}>
                      <tr>
                ...
                <div style={{ marginBottom: '16px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '8px', background: 'rgba(245, 158, 11, 0.1)' }}>
                ...
                <div className="flex justify-between border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)' }}>
                  <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setStep(2)}>{'< Back'}</button>
                  <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={performExport}>
                    Generate Seed {'>'}
                  </button>
                </div>
                  </>
            ...
            {step === 4 && (
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', flex: 1, gap: '16px', overflow: 'hidden', marginBottom: '16px' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <textarea 
                      value={exportedJson} 
                      readOnly 
                      style={{ flex: 1, fontFamily: 'monospace', width: '100%', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', resize: 'none', whiteSpace: 'pre' }} 
                    />
                  </div>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <textarea 
                      value={exportedSql} 
                      readOnly 
                      style={{ flex: 1, fontFamily: 'monospace', width: '100%', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', resize: 'none', whiteSpace: 'pre', background: 'rgba(255, 255, 255, 0.1)' }} 
                    />
                  </div>
                ...
                <div className="flex justify-between border-t" style={{ paddingTop: '16px', borderTop: '1px solid var(--app-border)', alignItems: 'center' }}>
                  <button className="btn" style={{ borderRadius: '12px', padding: '8px 16px', background: 'rgba(255,255,255,0.1)' }} onClick={() => setStep(3)}>{'< Back'}</button>
                  <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                    {executeResult && <span style={{ fontSize: '11px', fontWeight: 'bold' }}>{executeResult}</span>}
                    <button className="btn btn-primary" style={{ borderRadius: '12px', padding: '8px 24px', background: 'linear-gradient(135deg, var(--app-blue), #6366f1)', border: 'none' }} onClick={handleExecuteSql} disabled={executing}>
